...
namespace PuzzleStuff.BombDisposal
{
    static class SignalLink
    {
        ...
        public static void SolveCubeArrangement()
        {
            ...
            // Generate SVG
            var xml = XDocument.Parse(File.ReadAllText(@"D:\c\PuzzleStuff\DataFiles\Bomb Disposal Puzzle Hunt\Signal Link\Maze (v5, 1 after fixing loop bug).svg"));
            ...
            File.WriteAllText(@"D:\c\PuzzleStuff\DataFiles\Bomb Disposal Puzzle Hunt\Signal Link\Maze (v5, 2 after algorithm added lines).svg", xml.ToString(SaveOptions.DisableFormatting));
        ...
        public static void SolveSlitherRooms()
        {
            ...
            var xml = XDocument.Parse(File.ReadAllText(@"D:\c\PuzzleStuff\DataFiles\Bomb Disposal Puzzle Hunt\Signal Link\Maze (v5, 4 logic puzzle prep).svg"));
            ...
            File.WriteAllText(@"D:\c\PuzzleStuff\DataFiles\Bomb Disposal Puzzle Hunt\Signal Link\Maze (v5, 5 logic puzzle with clues from algorithm).svg", xml.ToString(SaveOptions.DisableFormatting));
        }
        ...
        {
            var xml = XDocument.Parse(File.ReadAllText(@"D:\c\PuzzleStuff\DataFiles\Bomb Disposal Puzzle Hunt\Signal Link\Maze (v4, 5 logic puzzle 2).svg"));
            ...
            foreach (var path in newPaths)
                xml.Root.Add(path);
            File.WriteAllText(@"D:\c\PuzzleStuff\DataFiles\Bomb Disposal Puzzle Hunt\Signal Link\Maze (v4, 5 logic puzzle 3).svg", xml.ToString(SaveOptions.DisableFormatting));
        }
    }
}
